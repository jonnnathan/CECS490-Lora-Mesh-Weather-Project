...
//*/
//ensorManager sensorManager;
//
/// Timing for sensor reads
//tatic unsigned long lastSensorRead = 0;
//
/// ╔═══════════════════════════════════════════════════════════════════════════╗
/// ║                         STATISTICS                                        ║
/// ╚═══════════════════════════════════════════════════════════════════════════╝
//
//nsigned long txSeq = 0;
//nsigned long totalTxAttempts = 0;
//nsigned long successfulTx = 0;
//
/// These are accessed by serial_output.cpp
//nsigned long validRxMessages = 0;
//nsigned long duplicateRxMessages = 0;
//
/// ╔═══════════════════════════════════════════════════════════════════════════╗
/// ║                         TIMING VARIABLES                                  ║
/// ╚═══════════════════════════════════════════════════════════════════════════╝
//
//tatic unsigned long lastRxCheck = 0;
//tatic unsigned long lastDisplayUpdate = 0;
//tatic unsigned long lastGPSStatusPrint = 0;
//tatic unsigned long lastNodeCheck = 0;
//tatic unsigned long lastStatsPrint = 0;
//tatic unsigned long lastNeighborPrune = 0;
//tatic unsigned long lastBeaconSent = 0;
//
...
/// ╚═══════════════════════════════════════════════════════════════════════════╝
//
//tatic uint8_t primaryTxThisSlot = 0;
//tatic bool wasInSlot = false;
//
/// ╔═══════════════════════════════════════════════════════════════════════════╗
/// ║                         SENSOR READING                                    ║
/// ╚═══════════════════════════════════════════════════════════════════════════╝
...
/// ╚═══════════════════════════════════════════════════════════════════════════╝
//
//oid buildFullReport(FullReportMsg& report) {
//   // Clear the struct
...
/// ╚═══════════════════════════════════════════════════════════════════════════╝
//
//oid transmitQueuedForwards(uint8_t slotEndSecond) {
...
/// ╚═══════════════════════════════════════════════════════════════════════════╝
//
//tatic char serialCmdBuffer[64];
//tatic uint8_t serialCmdIndex = 0;
//
//oid processSerialCommands() {
